...
from app.demo_seed import upsert_demo_student as upsert_demo_student_data
from app.demo_seed import seed_demo_data as seed_demo_data_bundle
...
def seed_demo_student():
    ...
    result = upsert_demo_student_data(force_update=force_update)
    print(f"Demo student seed result: {result['action']} ({result['email']})")
...
def seed_demo_data():
    ...
    result = seed_demo_data_bundle(force_update_student=force_update_student, reset=False)
    print(
        f"Demo data seeded | student={result['student'].get('action')} "
